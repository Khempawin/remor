...
training_args = GRPOConfig(
        output_dir="saves/Qwen-Review-7B-ICLR-GRPO-H",
        ...
        reward_weights=[0.01, 0.01, 0.11, 0.01, 0.01, 0.01, 0.01, 0.16, 8.67],
        # reward_weights=[0.0, 0.0, 0.10, 0.0, 0.0, 0.0, 0.0, 0.15, 8.74],
        )
...
#reward_tokenizer.save_pretrained("saves-ext/Qwen-Review-7B-ICLR-GRPO-H")
